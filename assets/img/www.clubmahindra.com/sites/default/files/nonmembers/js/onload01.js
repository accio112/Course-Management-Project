...
ZOOM_STEPS_SIZE = 0.3;   	 //STEPS SIZE FOR ZOOM
...
var Book = {
	...
	all_pages: function() {
		...
		$('.flipbook-tocHolder a').click(function() {
...
var Navigation = {
	...
	init: function() {
		...
		$('nav .contents').on('click', function() {



			$('#index-contents').css('visibility', 'visible');
		...
		$('#close-index').on('click', function() {
			...
			$('#index-contents').css('visibility', 'hidden');
